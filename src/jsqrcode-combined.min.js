    ...
    this.image = null, this.possibleCenters = [], this.hasSkipped = !1, this.crossCheckStateCount = new Array(0, 0, 0, 0, 0), this.resultPointCallback = null, this.__defineGetter__("CrossCheckStateCount", function () {
        ...
        if (startSize > 3) {
            ...
            for (var stdDev = Math.sqrt(square / startSize - average * average), limit = Math.max(.2 * average, stdDev), i = 0; i < this.possibleCenters.length && this.possibleCenters.length > 3; i++) {
                ...
                Math.abs(pattern.EstimatedModuleSize - average) > limit && (qrCode.removeArrayElement(this.possibleCenters, i, i--));
            }
        }
...
DataBlock.getDataBlocks = function (rawCodewords, version, ecLevel) {
    ...
    return ret
}, qrCode.removeArrayElementArray = function (array, from, to) {
    var rest = array.slice((to || from) + 1 || array.length);
    return array.length = 0 > from ? array.length + from : from, array.push.apply(array, rest)
};
